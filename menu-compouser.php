...
if (!defined('WPDEV_CP_VERSION'))    define('WPDEV_CP_VERSION',  '0.4' );                                // 0.1
...
if (!class_exists('wpdev_compose')) {
    class wpdev_compose {
        ...
        function wpdev_compose() {
            ...
            require_once(WPDEV_CP_PLUGIN_DIR. '/include/wpdev_gui_cust.php' ); // Connect my GUI class

            if (! WPDEV_CP_PUBLIC_VERSION) {
                $this->gui_compose = &new wpdev_gui_cust('wpdev-cp',__FILE__,__('Menu compouser'), __('Site Menu'),'object');
            ...
            if (WPDEV_CP_PUBLIC_VERSION)
                $this->gui_icons = &new wpdev_gui_cust('wpdev-cp-icons',__FILE__  ,__('Uploading icons for pages and categories'), __('Icons'),'object' );
            else
                $this->gui_icons = &new wpdev_gui_cust('wpdev-cp-icons',__FILE__  ,__('Uploading icons for pages and categories'), __('Icons'),'submenu','', __FILE__ . $reference_for_submenu );
            ...
            $this->gui_settings = &new wpdev_gui_cust('wpdev-cp-option',__FILE__  ,__('Menu compouser settings'), __('Settings'),'submenu','', __FILE__ . $reference_for_submenu);
        ...
        <div class='meta-box'>
            <div  class="postbox gdrgrid" > <h3 class='hndle'><span><?php _e('Recomended WordPress Plugins'); ?></span></h3>
                <div class="inside">
                    ...
                    <a href="http://booking.wpdevelop.com" class="button-primary" target="_blank">Demo site</a>
                    </p>
