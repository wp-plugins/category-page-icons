...
**Old version. Current version of plugin is not supporting, right now. Please wait for the next major update of plugin.**
...
== Changelog ==
= 0.9.2 =
 * Security fix. Unfortunately,  its block  upload of files,  until next update of plugin.
= 0.9.1 =
