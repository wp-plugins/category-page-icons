...
if (!class_exists('wpdev_gui')) {
    ...
    class wpdev_gui {
        ...
        function wpdev_gui($gui_html_id, $file_path, $page_title, $menu_title, $menu_type = '', $icon_name='',$page_parent='') {
        ...
        function on_admin_menu() {
            ...
            switch ( $this->menu_type ) {
                ...
                case 'submenu' :    $this->pagehook = add_submenu_page($this->parent_page, $this->page_title, $this->menu_title, 5, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page')  ); $this->icon_name='options-general';break;
                case 'object':      $this->pagehook = add_object_page( $this->page_title, $this->menu_title, 5, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page'), $icon_url  ); $this->icon_name='options-general';break;
                default: $this->pagehook = add_menu_page( $this->page_title, $this->menu_title, 5, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page'), $icon_url  ); $this->icon_name='options-general';
            }
